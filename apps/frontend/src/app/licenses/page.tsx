...
export default function LicensesPage() {
  ...
  return (
    ...
    >
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-bold text-gray-900">3. License tiers</h2>
        <div className="space-y-4 rounded-2xl border border-gray-200 bg-gray-50/80 p-5">
          <div>
            <h3 className="font-semibold text-gray-900">Tier A — Free (flat SVG/PNG)</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900">Tier B — Single asset ($3)</h3>
            <ul className="mt-2 list-inside list-disc space-y-1 pl-1 text-gray-800">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">Tier C — Subscription / Bundle</h3>
            <ul className="mt-2 list-inside list-disc space-y-1 pl-1 text-gray-800">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-bold text-gray-900">5. Samples and watermarks</h2>
        <p>
