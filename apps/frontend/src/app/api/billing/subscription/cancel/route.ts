...
export async function POST() {
  ...
  try {
    const r = await fetchBackendApi(apiBase.baseUrl, '/billing/subscriptions/cancel', {
      method: 'POST',
      headers: {
    ...
    return backendUnreachableResponse(apiBase.baseUrl, '/billing/subscriptions/cancel', err);
  }
}
