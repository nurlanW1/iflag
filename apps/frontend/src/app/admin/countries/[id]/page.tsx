    ...
    <div className="marketplace-shell">
      ...
      >
        <Link
          ...
          className="inline-flex items-center gap-2 text-gray-600 hover:text-[var(--brand-blue)] mb-4 font-medium transition-colors"
        >
          <ArrowLeft size={18} />
          Back to Countries
        </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            <h2 className="text-xl font-semibold text-[#2a2a2a] mb-6 flex items-center gap-2">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl focus:outline-none focus:border-[var(--brand-blue)] focus:ring-4 focus:ring-[#2563eb]/10 transition-all text-[#2a2a2a] font-mono text-sm"
                  required
                  placeholder="e.g., united-states"
                />
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    maxLength={2}
                    className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl focus:outline-none focus:border-[var(--brand-blue)] focus:ring-4 focus:ring-[#2563eb]/10 transition-all text-[#2a2a2a] font-mono text-center font-bold"
                    placeholder="US"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-neutral-200 rounded-xl focus:outline-none focus:border-[var(--brand-blue)] focus:ring-4 focus:ring-[#2563eb]/10 transition-all text-[#2a2a2a] font-mono text-center"
                    placeholder="840"
                  />
                </div>
              </div>
          ...
          {!isNew && (
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-[#2a2a2a] flex items-center gap-2">
                  <FileText size={24} className="text-[var(--brand-blue)]" />
                  Flag Files
                </h2>
              ...
              {flagFiles.length === 0 ? (
                <div className="text-center py-12 text-gray-400 border-2 border-dashed border-neutral-200 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {flagFiles.map((flag) => (
                    <div key={flag.id} className="border-2 border-neutral-200 rounded-xl p-4 hover:border-[var(--brand-blue)] transition-colors group">
                      ...
                      <div className="space-y-2">
                        <div className="text-sm font-semibold text-[#2a2a2a] truncate">{flag.file_name}</div>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  ...
                  <div className="text-3xl font-semibold text-white">{country.flag_count}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                  <div className="text-sm text-white/80 mb-1">Published Flags</div>
                  <div className="text-3xl font-semibold text-green-300">{country.published_flag_count}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
