...
export const marketplaceProductCardGridClasses =
  'grid min-w-0 grid-cols-1 gap-3.5 xs:grid-cols-2 xs:gap-4 sm:gap-5 md:grid-cols-3 md:gap-6 lg:grid-cols-4 lg:gap-6 xl:grid-cols-4 xl:gap-7 2xl:grid-cols-5 2xl:gap-8';
