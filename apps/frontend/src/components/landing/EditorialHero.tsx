...
export function EditorialHero({
  ...
  return (
    <section
      className="relative min-h-[14rem] overflow-hidden border-b border-neutral-200/90 sm:min-h-[16rem] lg:min-h-[clamp(17rem,22vw,28rem)]"
      aria-labelledby={headingId}
    >
      {/* Marketing hero — no product watermark; illustration anchored right, shorter band. */}
      <div
        className="pointer-events-none absolute inset-0 z-0 bg-[#eef2fb] bg-no-repeat bg-right bg-[length:auto_100%] sm:bg-[length:auto_105%]"
        style={{ backgroundImage: 'url(/images/mypexel1.webp)' }}
        aria-hidden
      />
      {/* Light left scrim — readable type; covers any residual pattern in the sky crop. */}
      <div
        className="pointer-events-none absolute inset-0 z-[2] bg-gradient-to-r from-[#fafaf9]/88 from-[-5%] via-[#fafaf9]/52 via-[38%] to-transparent to-[72%]"
        aria-hidden
      />
      <div className="marketplace-shell relative z-10 py-5 sm:py-7 lg:py-9">
        <div className="max-w-xl pt-2 sm:pt-4 lg:pt-5">
          <div className="flex flex-col justify-center">
            ...
            <form onSubmit={onSubmitSearch} className="mt-5 lg:mt-6" role="search" aria-label="Search catalog">
