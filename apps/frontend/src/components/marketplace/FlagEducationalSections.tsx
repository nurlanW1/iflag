...
export function FlagEducationalSections({ productTitle }: Props) {
  ...
  return (
    <article className="mt-12 max-w-none border-t border-neutral-100 pt-10">
      ...
      <section className="mt-8 space-y-3" aria-labelledby="meaning-heading">
        <h2 id="meaning-heading" className="text-base font-semibold text-[#2a2a2a]">
      ...
      <section className="mt-8 space-y-3" aria-labelledby="colors-heading">
        <h2 id="colors-heading" className="text-base font-semibold text-[#2a2a2a]">
          Colors of the flag
        </h2>
        <p className="text-sm leading-relaxed text-neutral-500">
      ...
      <section className="mt-8 space-y-3" aria-labelledby="history-heading">
        <h2 id="history-heading" className="text-base font-semibold text-[#2a2a2a]">
          History of the flag
        </h2>
        <p className="text-sm leading-relaxed text-neutral-500">
      ...
      <section className="mt-8 space-y-3" aria-labelledby="usage-heading">
        <h2 id="usage-heading" className="text-base font-semibold text-[#2a2a2a]">
